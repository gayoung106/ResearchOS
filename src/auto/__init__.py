...
_EXPORTS = {
    ...
    "DraftResearchModelQualityItem": "src.auto.research_intent",
    "DraftResearchModelQualityReport": "src.auto.research_intent",
    ...
    "evaluate_draft_research_model_quality": "src.auto.research_intent",
